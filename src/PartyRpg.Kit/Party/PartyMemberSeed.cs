...
/// on a member's figure — so no member record can disagree with where its equipment went.
/// </remarks>
public sealed record PartyMemberSeed
{
    ...
    /// <param name="characterClass">The class definition the character belongs to.</param>
